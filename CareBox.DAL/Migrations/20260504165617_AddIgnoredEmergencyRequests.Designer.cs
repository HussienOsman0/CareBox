...
namespace CareBox.DAL.Migrations
{
    ...
    [Migration("20260504165617_AddIgnoredEmergencyRequests")]
    partial class AddIgnoredEmergencyRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CareBox.DAL.Models.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CareBox.DAL.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CareBox.DAL.Models.IgnoredEmergencyRequest", b =>
                {
                    b.Property<long>("EmergencyRequestId")
                        .HasColumnType("bigint");

                    b.Property<int>("ServiceProviderId")
                        .HasColumnType("int");

                    b.HasKey("EmergencyRequestId", "ServiceProviderId");

                    b.HasIndex("ServiceProviderId");

                    b.ToTable("IgnoredEmergencyRequests");
                });
            ...
            modelBuilder.Entity("CareBox.DAL.Models.Product", b =>
                {
                    ...
                    b.Property<int?>("HorizontalPosition")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CareBox.DAL.Models.BookingService", b =>
                {
                    ...
                    b.HasOne("CareBox.DAL.Models.Service", "Service")
                        .WithMany("BookingServices")
            ...
            modelBuilder.Entity("CareBox.DAL.Models.Cart", b =>
                {
                    b.HasOne("CareBox.DAL.Models.Client", "Client")
                        .WithOne("Cart")
                        .HasForeignKey("CareBox.DAL.Models.Cart", "ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CareBox.DAL.Models.CartItem", b =>
                {
                    b.HasOne("CareBox.DAL.Models.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("CareBox.DAL.Models.IgnoredEmergencyRequest", b =>
                {
                    b.HasOne("CareBox.DAL.Models.EmergencyRequest", "EmergencyRequest")
                        .WithMany("IgnoredRequests")
            ...
            modelBuilder.Entity("CareBox.DAL.Models.Invoice", b =>
                {
                    ...
                    b.HasOne("CareBox.DAL.Models.EmergencyRequest", "EmergencyRequest")
                        .WithOne("Invoice")
                        .HasForeignKey("CareBox.DAL.Models.Invoice", "EmergencyRequestId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CareBox.DAL.Models.Order", "Order")
                        .WithOne("Invoice")
                        .HasForeignKey("CareBox.DAL.Models.Invoice", "OrderId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("CareBox.DAL.Models.Product", b =>
                {
                    b.HasOne("CareBox.DAL.Models.ProductCategory", "ProductCategory")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("CareBox.DAL.Models.Service", b =>
                {
                    b.HasOne("CareBox.DAL.Models.ServiceCategory", "ServiceCategory")
                        .WithMany("Services")
